...
public class GuiComputerCloverPad extends GuiComputerBase {

	public static final ResourceLocation TEXTURE = new ResourceLocation(ESAPI.MODID,
			"textures/gui/computer/clover_pad.png");
	public static final RenderTexutreFrame BG_FRAME = GuiComputerTutorialPad.BG_FRAME;

	public GuiComputerCloverPad(ContainerComputer containerComputer) {
