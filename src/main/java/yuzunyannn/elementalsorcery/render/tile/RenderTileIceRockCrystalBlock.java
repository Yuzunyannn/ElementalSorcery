...
public class RenderTileIceRockCrystalBlock extends TileEntitySpecialRenderer<TileIceRockCrystalBlock> {
	...
	public RenderTileIceRockCrystalBlock() {

	}

	@Override
	public void render(TileIceRockCrystalBlock tile, double x, double y, double z, float partialTicks, int destroyStage,
			float alpha) {
		...
		for (EnumFacing facing : EnumFacing.HORIZONTALS) {
			...
			FaceStatus status = tile.getFaceStatus(facing);
