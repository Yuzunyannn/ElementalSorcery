...
public class ModelElf extends ModelBiped {
	...
	public ModelElf() {
		...
		bipedRightLeg.cubeList.add(new ModelBox(bipedRightLeg, 18, 54, -2.5F, 4.5F, -2.5F, 5, 6, 5, 0.0F, false));
		...
		bipedLeftArm.setRotationPoint(6.0F, 1.0F, 0.0F);
		bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 0, 35, -2.0F, -1.0F, -2.0F, 4, 12, 4, 0.0F, false));
		bipedLeftArm.cubeList.add(new ModelBox(bipedLeftArm, 17, 35, -2.5F, -1.25F, -2.5F, 5, 4, 5, 0.0F, false));

		bipedRightArm = new ModelRenderer(this);
		bipedRightArm.setRotationPoint(-6.0F, 0.875F, 0.0F);
		bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 0, 35, -2.0F, -0.875F, -2.0F, 4, 12, 4, 0.0F, false));
		bipedRightArm.cubeList.add(new ModelBox(bipedRightArm, 17, 35, -2.5F, -1.125F, -2.5F, 5, 4, 5, 0.0F, false));
	}
