...
public class BlockAbsorbBox extends BlockContainer {
	...
	public BlockAbsorbBox() {
		super(Material.ROCK);
		this.setUnlocalizedName("absorbBox");
	...
	public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
		...
		if (tileentity instanceof TileAbsorbBox && !worldIn.isRemote) {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (worldIn.isRemote)
			return true;
		playerIn.openGui(ElementalSorcery.instance, ESGuiHandler.GUI_ABSORB_BOX, worldIn, pos.getX(), pos.getY(),
				pos.getZ());
		return true;
	}
}
