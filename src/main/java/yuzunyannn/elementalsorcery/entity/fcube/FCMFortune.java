...
public class FCMFortune extends FairyCubeModule {
	...
	public static boolean matchAndConsumeForCraft(World world, BlockPos pos, IElementInventory inv) {
		...
		return FairyCubeModuleInGame.matchAndConsumeForCraft(world, pos, inv,
				...
				ElementHelper.toList(ESObjects.ELEMENTS.WOOD, 24, 400, ESObjects.ELEMENTS.METAL, 100, 300));
	}
	...
	public boolean absorbElements(IElementInventory einv) {
		...
		if (absorbRate > 0) {
			...
			ElementStack wood = new ElementStack(ESObjects.ELEMENTS.WOOD, dCount, 125);
