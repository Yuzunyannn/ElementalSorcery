...
import yuzunyannn.elementalsorcery.block.BlockMeteorite;
...
import yuzunyannn.elementalsorcery.render.tile.RenderTileCloverComputer;
...
public class ESInit {
	...
	private static final void instanceItems() throws ReflectiveOperationException {
		...
		ESObjects.ITEMS.DISK = new ItemDisk();
